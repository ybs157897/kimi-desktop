    ...
    >
      <div className="mx-auto w-full max-w-[var(--layout-thread-max-width)] px-6 pb-8 pt-5">
        ...
        <div className="mb-4 flex justify-end">
          <div className="skeleton-block h-10 w-2/5 max-w-[18rem] rounded-[var(--radius-lg)]" />
        </div>
        ...
        {/* Code block */}
        <div className="mb-4 rounded-[var(--radius-lg)] border border-[var(--color-border-light)] p-3">
          <div className="skeleton-block mb-2.5 h-3 w-28 rounded-[var(--radius-xs)]" />
          <div className="space-y-1.5">
            <div className="skeleton-block h-3 w-full rounded-[var(--radius-xs)]" />
            <div className="skeleton-block h-3 w-[92%] rounded-[var(--radius-xs)]" />
            <div className="skeleton-block h-3 w-[70%] rounded-[var(--radius-xs)]" />
          </div>
        </div>
        {/* Tool row */}
        <div className="flex items-center gap-2">
          <div className="skeleton-block h-5 w-5 rounded-[var(--radius-sm)]" />
          <div className="skeleton-block h-3 w-44 rounded-[var(--radius-xs)]" />
        </div>
      </div>
    </div>
  );
