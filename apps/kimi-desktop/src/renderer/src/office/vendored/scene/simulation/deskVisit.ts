import type { Agent, Desk, DeskVisitMission, DeskVisitStop } from '#/office/vendored/types/agent'
import {
  AGENT_ROSTER,
  DESKS,
  HANDOFF_STATUS,
...
import {
  ...
  planWalkToDeskSeat,
  planWalkToDeskVisit,
} from '#/office/vendored/scene/navigation/officeNavigation'
import { MovementSystem } from '#/office/vendored/scene/systems/MovementSystem'
import type { AgentEntity } from '#/office/vendored/scene/entities/AgentEntity'
import { talkFacingToward } from '#/office/vendored/scene/systems/movementFacing'
