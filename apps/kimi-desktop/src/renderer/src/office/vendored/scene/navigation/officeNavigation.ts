import type { Desk } from '#/office/vendored/types/agent'
import { DESKS } from '#/office/vendored/scene/layout/officeLayout'
import {
  COL_AISLE_MARGIN,
  getRowCorridorY,
  SIDE_OFFSET,
} from '#/office/vendored/scene/navigation/deskNavGeometry'
import {
  createNavContext,
  polylineCrossesSeat,
  segmentCrossesSeat,
...
} from '#/office/vendored/scene/navigation/navPathfinding'

export type { NavPathContext } from '#/office/vendored/scene/navigation/navPathfinding'
